...
OUTPUT_DIR = Path(
    "results/figures/false_positive_gradcam"
)
...
false_positive_indices = np.load(
    indices_path
)
...
print(
    "\nFalse-positive Grad-CAM analysis "
